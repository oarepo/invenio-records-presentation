...
Invenio Records Presentation is on PyPI so all you need is:

.. code-block:: console

    $ pip install invenio-records-presentation
...
.. code-block:: console
    ...
    $ pip install invenio-records-presentation[postgresql,elasticsearch6]
